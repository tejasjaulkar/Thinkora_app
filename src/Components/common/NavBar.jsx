            ...
            <div className='flex w-11/12 max-w-maxContent items-center justify-between'>
                ...
                <div className={`flex md:hidden  relative gap- flex-row ${token !== null && user?.accountType !== "Instructor" ? " -left-12" : ""}`}>
                    ...
                    <div ref={show} className='mobNav z-50'>
                        <nav className=' items-center flex flex-col absolute w-[200px] -left-[80px] -top-7  glass2' ref={show}>
                            ...
                            {token && (
                                <Link to='/ai-dashboard' onClick={() => { dispatch(setProgress(100)); shownav() }} className="p-2">
                ...
                <nav>
                    <ul className=' flex-row gap-x-6 text-richblack-25 gap-5 hidden md:flex'>
                        ...
                        {token && (
                            <Link to='/ai-dashboard' onClick={() => { dispatch(setProgress(100)) }} className="flex items-center gap-2 text-richblack-25 hover:text-gray-400 transition-colors">
                                <FaRobot />
                                <span className="hidden lg:block">AI Hub</span>
                            </Link>
                        )}
                    </ul>
                </nav>
                ...
                <div className="hidden md:flex items-center ml-4">
                    <button
                        ...
                        title="AI Assistant"
                        className="flex items-center gap-2 p-2 rounded-full hover:bg-richblack-800 transition"
                    >
                        <FaRobot className="w-6 h-6 text-white" />
                        <span className="text-white font-medium text-base">Start Thinking</span>
                    </button>
                </div>
            </div>

            {aiModalOpen && <AiAssistantModal onClose={() => setAiModalOpen(false)} />}
        </div>
    )
}
