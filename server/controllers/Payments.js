...
exports.capturePayment = async (req, res) => {
    ...
    if (!instance) {
        return res.status(503).json({
            success: false,
            message: 'Payment gateway is temporarily disabled. Please contact support.',
        });
    }
...
exports.verifySignature = async (req, res) => {
        ...
        const enrolleStudent = async (courses, userId) => {
            ...
            try{
                ...
                return true; // Return success instead of sending response
            }
            catch(error) {
                console.error(error);
